...
class ForegroundHandler:
    def __init__(self, canvas_width, canvas_height):
        ...
        # Background creator
        self.foreground_creator = ForegroundProtocolHandler()
    ...
    def foreground_create_process(self, track_cover_image, design_pattern, image_size_ratio, positioning_style):
